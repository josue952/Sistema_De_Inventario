...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE SUCURSALES"), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(45, 8, utf8_decode('UBICACION'), 1, 0, 'C', 1);
      $this->Cell(45, 8, utf8_decode('DEPARTAMENTO'), 1, 0, 'C', 1);
      $this->Cell(40, 8, utf8_decode('MUNICIPIO'), 1, 0, 'C', 1);
      $this->Ln(8);
   }
...
$sqlUsuarios = $conexion->query(" SELECT * FROM sucursales ");//traemos datos de la empresa desde BD
...
while ($row = $sqlUsuarios->fetch_object()) {
   $pdf->Cell(20, 8, utf8_decode($row->idSucursal), 1, 0, 'C', 0);
   $pdf->Cell(40, 8, utf8_decode($row->NombreSucursal), 1, 0, 'C', 0);
   $pdf->Cell(45, 8, utf8_decode($row->Ubicacion), 1, 0, 'C', 0);
   $pdf->Cell(45, 8, utf8_decode($row->Departamento), 1, 0, 'C', 0);
   $pdf->Cell(40, 8, utf8_decode($row->Municipio), 1, 0, 'C', 0);
   $pdf->Ln(8);
}

$pdf->Output('ReporteSucursales.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
